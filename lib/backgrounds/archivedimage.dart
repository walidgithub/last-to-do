...
class ArchivedImage extends StatefulWidget {
  String priority;
  ArchivedImage(this.priority);

  @override
  State<ArchivedImage> createState() => _ArchivedImageState();
}

class _ArchivedImageState extends State<ArchivedImage> {
